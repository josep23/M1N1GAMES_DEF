    ...
    public void comprobacion(){
        ...
        if (contador == 25) {
            ...
            if (juego1==true&&juego2==true&&juego3==true&&juego4&&juego5==true&&juego6==true){
                ...
                Movimientos=0;
                FirebaseFirestore.getInstance().collection("Jugador").add(new Post("6", Movimientos6));
                System.out.println("██╗░░░██╗██╗░█████╗░████████╗░█████╗░██████╗░██╗░█████╗░");
                System.out.println("██║░░░██║██║██╔══██╗╚══██╔══╝██╔══██╗██╔══██╗██║██╔══██╗");
                System.out.println("╚██╗░██╔╝██║██║░░╚═╝░░░██║░░░██║░░██║██████╔╝██║███████║");
                System.out.println("░╚████╔╝░██║██║░░██╗░░░██║░░░██║░░██║██╔══██╗██║██╔══██║");
                ...
                Movimientos=0;
                binding.textView3.setText("Tienes "+ Movimientos +" Movimientos");
                FirebaseFirestore.getInstance().collection("Jugador").add(new Post("5", Movimientos5));
                mapa6(matriz);
                juego6=true;
            }
                ...
                Movimientos=0;
                binding.textView3.setText("Tienes "+ Movimientos +" Movimientos");
                FirebaseFirestore.getInstance().collection("Jugador").add(new Post("4", Movimientos4));
                mapa5(matriz);
                juego5=true;
            }
                ...
                Movimientos=0;
                binding.textView3.setText("Tienes "+ Movimientos +" Movimientos");
                FirebaseFirestore.getInstance().collection("Jugador").add(new Post("3", Movimientos3));
                mapa4(matriz);
                juego4=true;
            }
                ...
                Movimientos=0;
                binding.textView3.setText("Tienes "+ Movimientos +" Movimientos");
                FirebaseFirestore.getInstance().collection("Jugador").add(new Post("2", Movimientos2));
                mapa3(matriz);
                juego3=true;
            }
            else if (juego1==true){
                ...
                Movimientos=0;
                binding.textView3.setText("Tienes "+ Movimientos +" Movimientos");
                FirebaseFirestore.getInstance().collection("Jugador").add(new Post("1", Movimientos1));
                mapa2(matriz);
                juego2=true;
            }
